              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <button class="dropdown-item edit-expense" data-bs-toggle="modal" data-bs-target="#editExpenseModal"
                    data-id="{{ $expense->id }}" data-route="{{ route('expenses.update', $expense->id) }}" {{--
                    PERBAIKAN: Tambah data-route --}} data-category-id="{{ $expense->category_id }}"
                    data-amount="{{ $expense->amount }}" data-currency="{{ $expense->currency }}"
                    data-balance-id="{{ $expense->balance_id }}" data-date="{{ $expense->date }}"
                    data-reference="{{ $expense->reference }}" data-description="{{ $expense->description }}">
...
@include('admin.expense.create-modal')
@include('admin.expense.edit-modal')
