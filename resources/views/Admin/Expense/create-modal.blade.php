      ...
      <div class="modal-body">
        <form action="{{ route('expenses.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" id="expense-date" name="date" value="{{ old('date') }}" required>
            @error('date')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="expense-reference" name="reference" value="{{ old('reference') }}" placeholder="Optional reference code or note">
            @error('reference')
              <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
